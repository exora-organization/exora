  ...
  return (
    <div className="w-full">
      <div className="group bg-white/80 backdrop-blur-xl border border-white/60 p-8 sm:p-10 pt-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden">
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-1 tracking-tight">Reset Password</h2>
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Button 
              type="submit" 
              className="w-full h-14 bg-gradient-to-r from-[#0a9b5c] to-[#08824d] hover:from-[#08824d] hover:to-[#06683e] text-white font-extrabold tracking-widest uppercase rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 flex items-center justify-center space-x-2 transition-all duration-300 mt-4 group" 
              disabled={isLoading}
            >
        ...
        <div className="flex flex-col items-center justify-center mt-6 w-full pt-4 border-t border-gray-100">
          <Link href="/login" className="px-4 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-900 text-xs font-bold transition-colors w-full text-center">
