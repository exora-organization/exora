      ...
      <div className="bg-white rounded-2xl border border-[#E8E3D9] shadow-sm p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {stats?.casesByStatus && Object.entries(stats.casesByStatus).map(([status, count]) => (
            <Link key={status} href="/export-cases" className="flex flex-col p-5 rounded-2xl bg-[#F9FAFB] border border-[#E8E3D9] hover:border-[#00A651]/40 hover:bg-[#EBF8F2]/40 transition-all group">
