      ...
      {isRedirecting ? (
        ...
        <RoleGuard allowedRoles={["company_owner"]}>
          ...
          `}>
            ...
            {/* Profile Link & Logout */}
            <div className="p-6 mt-auto border-t border-[#E8E3D9] space-y-3">
              <Link
                href="/own-company-profile"
                className="flex items-center gap-2 text-xs font-bold text-[#4B5563] hover:text-[#00A651] transition-colors"
              >
