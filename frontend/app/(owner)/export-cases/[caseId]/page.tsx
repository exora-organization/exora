...
export default function OwnerExportCaseDetailPage() {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
      {/* Back */}
      <Link href="/export-cases" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#00A651] hover:bg-[#008F44] text-white text-sm font-bold rounded-xl shadow-md shadow-[#00A651]/20 transition-all">
