...
export default function CompanyProfilePage() {
  ...
  const fields = [
    ...
    {
      icon: <Icon icon="solar:hashtag-bold-duotone" className="w-5 h-5 text-green-600"  />,
      bg: "bg-green-50",
      label: "Company ID",
    ...
    {
      icon: <Icon icon="solar:shield-check-bold-duotone" className="w-5 h-5 text-emerald-600"  />,
      bg: "bg-emerald-50",
      label: "Status",
