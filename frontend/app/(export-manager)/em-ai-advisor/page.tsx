    ...
    return (
      <div className="space-y-10 max-w-6xl mx-auto pb-12 text-[#1F2937]">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-2xl bg-blue-50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <Icon icon="solar:clock-circle-bold-duotone" className="w-6 h-6 text-blue-600" />
                </div>
                <p className="text-[11px] font-bold text-[#9CA3AF] uppercase tracking-widest">RAG Latency</p>
              </div>
              <div className="text-4xl font-black text-[#1F2937] mb-2">
          ...
          <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl p-6 transition-all hover:-translate-y-1 hover:shadow-2xl flex flex-col justify-between group">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <p className="text-[11px] font-bold text-[#9CA3AF] uppercase tracking-widest">SLA Compliance</p>
              </div>
              <div className="text-4xl font-black text-[#1F2937] mb-2">
            ...
            <div className="mt-2">
              <Badge className="bg-emerald-100 hover:bg-emerald-200 text-emerald-800 font-bold border-0">
                Compliant
              </Badge>
            </div>
          </div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-2xl bg-orange-50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <Icon icon="solar:global-bold-duotone" className="w-6 h-6 text-orange-600" />
                </div>
                <p className="text-[11px] font-bold text-[#9CA3AF] uppercase tracking-widest">Market Coverage</p>
              </div>
              <div className="flex items-baseline gap-1 mb-2">
                <span className="text-4xl font-black text-[#1F2937]">
                  {health?.kbCoverage?.filter(c => c.status === "Complete").length ?? 8}
                </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl transition-all hover:shadow-2xl p-8 lg:col-span-1">
            ...
            <div className="space-y-4 max-h-[350px] overflow-y-auto pr-1">
              {health?.kbCoverage?.map((item, idx) => (
                <div key={idx} className="flex justify-between items-center border-b pb-2 last:border-0 last:pb-0">
                  ...
                  <Badge className={`font-bold capitalize border-0 ${item.status === "Complete"
          ...
          <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl transition-all hover:shadow-2xl p-8 lg:col-span-2">
                ...
                <tbody className="divide-y divide-gray-200 text-sm font-medium">
                  {health?.samples?.map((sample, idx) => (
                    <tr key={idx} className="hover:bg-gray-50/50">
                      ...
                      <td className="py-3">
                        <Badge className={`font-black uppercase tracking-wider text-[10px] border ${sample.confidence === "high"
        ...
        <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl p-8 transition-all hover:shadow-2xl ">
          <div className="flex items-center gap-3 mb-4">
            <Icon icon="solar:code-square-bold-duotone" className="w-5 h-5 text-gray-600" />
      ...
      <>
        ...
        <div className="space-y-10 max-w-6xl mx-auto pb-12 text-[#1F2937]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Risk rollup */}
            <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl p-8 transition-all hover:shadow-2xl col-span-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                {countryRisks.slice(0, 4).map((cr, idx) => (
                  <div key={idx} className="p-3 bg-gray-50 border rounded-xl flex justify-between items-center">
                    ...
                    <Badge className={`font-black ${cr.score >= 80
          ...
          <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl p-8 transition-all hover:shadow-2xl ">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-2">
                <Icon icon="solar:filter-bold-duotone" className="w-4 h-4 text-gray-500" />
                <select
              ...
              {filteredCasesForFeed.map((c: any, i: number) => (
                <div key={i} className="border border-[#E8E3D9] rounded-2xl p-6 hover:shadow-md transition-all">
                  <div className="flex justify-between items-center border-b pb-3 mb-4">
                    ...
                    <Badge className={`font-bold capitalize border-0 ${(c.feasibilityScore ?? 0) >= 80
                        ? "bg-emerald-50 text-emerald-700"
  ...
  return (
    <>
      ...
      <div className="space-y-10 max-w-6xl mx-auto pb-12 text-[#1F2937]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl p-6 transition-all hover:-translate-y-1 hover:shadow-2xl flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-2xl bg-blue-50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <Icon icon="solar:document-text-bold-duotone" className="w-6 h-6 text-blue-600" />
                </div>
                <p className="text-[11px] font-bold text-[#9CA3AF] uppercase tracking-widest">Total Cases</p>
              </div>
              <div className="text-4xl font-black text-[#1F2937] mb-2">{stats?.totalExportCases || 0}</div>
            </div>
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl p-6 transition-all hover:-translate-y-1 hover:shadow-2xl flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-2xl bg-green-50 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                  <Icon icon="solar:pulse-bold-duotone" className="w-6 h-6 text-green-600" />
                </div>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {activeProducts.length > 0 ? (
                  activeProducts.slice(0, 2).map((p: any, i: number) => (
                    <span key={i} className="px-3 py-1.5 bg-[#FAF8F3]/80 border border-[#E8E3D9] text-[#1F2937] rounded-xl text-xs font-bold shadow-sm">
                      {p.name}
                    </span>
                  ))
                ) : (
                  <span className="text-xs font-bold text-[#9CA3AF] bg-gray-50 px-3 py-1.5 rounded-xl">Unknown</span>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="bg-white/90 backdrop-blur-xl border border-white/60 shadow-xl rounded-3xl transition-all hover:-translate-y-1 hover:shadow-2xl p-8 relative overflow-hidden group">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-green-100 flex items-center justify-center">
              <Icon icon="solar:cpu-bold-duotone" className="w-5 h-5 text-green-600" />
            </div>
            <div>
              ...
              {role === "export_manager" && (
                <>
                  <Button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl h-12 px-6 font-bold"
                  >
                    <Icon icon="solar:eye-bold-duotone" className="w-4 h-4 mr-2" /> Generate & Preview Quotation
                  </Button>
                  <Button
                  ...
                  >
                    <Icon icon="solar:eye-bold-duotone" className="w-4 h-4 mr-2" /> Generate & Preview Proforma
                  </Button>
                </>
              )}
