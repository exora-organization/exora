  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <Link href="/export-case" className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#00A651] hover:bg-[#008F44] text-white text-[13px] font-bold rounded-full shadow-md hover:shadow-lg transition-all mb-5">
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {pipelineSteps.map((step, idx) => (
                <Link key={idx} href={`/export-case/${caseId}/${step.href}`}>
