      ...
      {pricingResult && (
        <div className="space-y-6">
          ...
          <div className="flex justify-end pt-4">
            <Button onClick={() => router.push(`/export-case/${caseId}/financial`)} className="bg-[#00A651] hover:bg-[#008F44] text-white rounded-full px-8 h-12 text-[13px] font-bold shadow-md hover:shadow-lg transition-all group">
