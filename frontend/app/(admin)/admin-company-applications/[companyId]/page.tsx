  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-10">
      <div className="flex items-center gap-4 mb-8">
        <Link href="/admin-company-applications" className="p-2 bg-white hover:bg-[#EBF8F2] text-[#4B5563] hover:text-[#00A651] rounded-xl border border-[#E8E3D9] shadow-sm transition-colors flex items-center justify-center">
